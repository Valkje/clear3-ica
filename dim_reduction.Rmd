...
```{r}
run_icas <- function(dat_path, ns_comp, out_path = NULL) {
  set.seed(42)
...
fancy_mix_fig <- function(ica, n_row = 1, lims = c(-0.5, 0.5), 
...
fancy_mix_fig(icas$`5`, file.path(man_img_dir, "mixing_matrix_5_test.pdf"))
```
